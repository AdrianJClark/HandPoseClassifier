...
DWORD WINAPI SplitThread(void *param) {
	...
	printf("Mem: %d - Split %d into %d and %d at Depth %d. Entropy: %f               \n", pmc.PeakWorkingSetSize/1024, imagePoints.size(), imagePointsLeft.size(), imagePointsRight.size(), depth, maxEntropyVal);
